...
class MemcachedLockParallelSyncTest extends \PHPUnit_Framework_TestCase {
    ...
    public function test_parallel() {
        ...
        $Parallel->run('foo', function() use ($start) {
            $MemcachedLock = new MemcachedLock($MC = $this->getMemcached(), 'lock_', MemcachedLock::FLAG_USE_SELF_EXPIRE_SYNC);
